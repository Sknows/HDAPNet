...
def get_params():
    params = {
        'weight': '/root/autodl-tmp/yolo/ultralytics-20240920/ultralytics-main/runs/train/yolov8-bifpn-Dyhead4-p234-300-A403/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/root/autodl-tmp/yolo/ultralytics-main/VisDrone/VisDrone2019-DET-train/images/', '/root/autodl-tmp/yolo/ultralytics-20240920/ultralytics-main/234-300-reno-9')