...
def get_params():
    params = {
        'weight': '/root/autodl-tmp/yolo/ultralytics-20240920/ultralytics-main/runs/train/yolov113/weights/best.pt', # 只需要指定权重即可
        'device': 'cuda:0',
        'layer': '10', # string
        'dataset': '/root/autodl-tmp/yolo/ultralytics-main/VisDrone/VisDrone2019-DET-train/images',
        'num_images': 50,
        'save_path': '/root/autodl-tmp/yolo/ultralytics-20240920/ultralytics-main/runs/erf/yolov11-backbone.png'
    }
    return params
